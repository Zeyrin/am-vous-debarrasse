$(function () {
    ...
    new Headroom(e).init(),
        $("#nav").onePageNav({ currentClass: "active", changeHash: !0, scrollSpeed: 800, scrollThreshold: 0.5, filter: "", easing: "swing", begin: function () {}, end: function () {}, scrollChange: function (e) {} }),
    ...
    $(".counter").counterUp({ delay: 10, time: 3e3 }),
        $(".container").imagesLoaded(function () {
            var e = $(".grid").isotope({ transitionDuration: "1s", itemSelector: ".grid-item", percentPosition: !0, masonry: {} });
